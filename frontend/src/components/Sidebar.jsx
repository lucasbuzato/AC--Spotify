        ...
        <aside className="bg-Sidebar w-96 flex flex-col rounded-lg ml-2 mr-2">
            <header className="flex flex-col px-4 pt-3 pb-2">
                <div className="flex flex-row justify-between items-center py-1 px-2">
                    <div className="flex flex-row items-center">
                        ...
                        <button className="font-bold text-[#B3B3B3] flex flex-row items-center"><img className="h-5 w-5 mr-3" src="./svg-path (1).svg" alt="" />Sua Biblioteca</button>
                    </div>
                    <div >
                        <button className="mr-3"><img className="h-4 w-4" src="./Mais.svg" alt="" /></button>
                        <button className="m-2"><img className="h-4 w-4"  src="./Seta.svg" alt="" /></button>
                    </div>
                </div>
            </header>
            <div className="px-4 py-2">
                ...
                <div className="flex flex-row justify-between pl-2 pr-1 pt-0.5">
                    ...
                    <button className="flex flex-row items-center text-[#B3B3B3] text-sm pl-4 pr-3 py-1 font-medium">Recentes<img className=" ml-2 h-4 w-4" src="./More.svg" alt="" /></button>
                </div>
                <div className="mt-2">
                    <ul>
                        <li>
                            ...
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded mr-3" src="./liked-songs-64.png" alt="" />
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded mr-3" src="./Slayer.webp" alt="" />
                                <div className="flex flex-col justify-center">
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded mr-3" src="./Wake.jfif" alt="" />
                                <div className="flex flex-col justify-center">
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded mr-3" src="./Flying Beagle.jfif" alt="" />
                                <div className="flex flex-col justify-center">
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded-full mr-3" src="./ab67616100005174c7e6bd9e65eab62a53355576.jfif" alt="" />
                                <div className="flex flex-col justify-center">
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded mr-3" src="./Quadra.jfif" alt="" />
                                <div className="flex flex-col justify-center">
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded-full mr-3" src="./Sepultura.jfif" alt="" />
                                <div className="flex flex-col justify-center">
                        ...
                        <button className="text-start">
                            <div className="flex flex-row p-2">
                                <img className="w-12 h-12 rounded mr-3" src="./Megadeth.jfif" alt="" />
                                <div className="flex flex-col justify-center">
